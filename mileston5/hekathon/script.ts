...
form.addEventListener('submit', (event: Event) =>{
    ...
    // save from data the local storage with the username as the key
    const resumeData = {
        name,
        email,
        phone,
    ...
    // generte a sharable URL with the username only
...
downloadpdfbutton.addEventListener('click', () => {
    window.print(); // this will open the print dailogue and allow the user save as PDF
});
